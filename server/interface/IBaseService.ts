...
export default interface IBaseService {
  findAll(conditions?: any, projection?: any, sort?: any, populate?: any): Promise<Document[]>;

  findById(id: idType, projection?: any, sort?: any, populate?: any): Promise<Document | null>;

  findOne(conditions: any, projection?: any, sort?: any, populate?: any): Promise<Document | null>;
